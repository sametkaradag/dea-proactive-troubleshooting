...
PROJECT_ID="dea-live-208271"
REGION="us-central1"
TOPIC_NAME="dataform-failures"
SINK_NAME="dataform-failure-sink"
FUNCTION_NAME="troubleshoot-dataform"
SERVICE_ACCOUNT="916192744904-compute@developer.gserviceaccount.com" # Default compute SA for this project
USER_EMAIL=${USER_EMAIL:-"timbezold@google.com"} # Change this to the target recipient email
ALLOWED_DATAFORM_REPOSITORIES=${ALLOWED_DATAFORM_REPOSITORIES:-"21a477bc-21d2-4541-88a1-5f6d465c0bab"} # Comma separated list of repo names (e.g. "my-repo,other-repo"), leave empty for all
